  ...
  <div class="game-view">
    ...
    <div v-else class="data-loading">
      <div class="loading-content">
        ...
        <p class="loading-message">{{ $t('正在加载官场世界...') }}</p>
...
const panelTitles: Record<string, { title: string; icon: IconComponent }> = {
  ...
  Techniques: { title: '治国方略', icon: Zap },
  ...
  SectManagement: { title: '衙门经营', icon: Building2 },
  SectLibrary: { title: '衙门档案', icon: BookOpen },
  SectTasks: { title: '衙门任务', icon: ClipboardList },
