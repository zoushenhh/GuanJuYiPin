...
export const LOCAL_WORLDS: Omit<World, 'source'>[] = [
  ...
  },
  {
    ...
    name: '山区穷县',
    era: '大宋年间',
    description: '这是一处地处深山、物产匮乏的贫困县。百姓生活艰辛，赋税难征，盗匪横行。你是朝廷派来治理此地的官员，要在有限的资源下改善民生，维护治安。\n在这个贫困的地方，修仙之道行不通，唯有勤政爱民。你可以选择修桥铺路、兴修水利来改善民生，也可以剿灭盗匪、整顿治安来稳定社会。但每一步都需要银两，而国库空虚，百姓贫困，你必须在夹缝中寻找出路。有人选择向富商借贷，有人选择加征赋税，有人选择开源节流。这是一个考验官员智慧与手腕的时代，你将在穷山恶水之间探索为官之道。',
  },
  {
    id: 4,
    name: '水乡泽国',
