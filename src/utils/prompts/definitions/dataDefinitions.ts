...
[角色.属性](可改)
城市等级:{名称,阶段,当前进度,下一级所需,突破描述}(突破时必更新突破描述);声望:num;气血:{当前,上限};灵气:{当前,上限};神识:{当前,上限};寿命:{当前,上限}
...
[⚠️NPC生成质量要求]
出生:str,必填!出身背景描述(如"散修"/"名门望族子弟"/"山野猎户之子"),⚠️这不是年龄!禁止生成"年龄"字段!
...
属性:气血/灵气/神识的当前和上限必须与城市等级匹配,禁用占位符数值
...
组织名称:str;战力?:num[0-100];安定?:num[0-100];外门训练度?:num[0-100];府库?:{灵石,灵材,产品?,阵材?};设施?:{练功房?,藏经阁?,生产房?,护山大阵?}(等级0-10);最近结算?:str;月报?:[{时间,摘要,变化?}]
