...
[必须生成指令的场景]
□ 时间流逝 → add 元数据.时间.分钟 (施政/办公/战斗/对话都要推进时间!)
□ 位置变化 → set 角色.位置 {描述,x,y,发展活力,民心支持度}
...
□ 战斗受伤 → add 角色.属性.健康.当前 (负数)
□ 技能消耗 → add 角色.属性.民心.当前 (负数,按技能消耗%)
□ 智慧消耗 → add 角色.属性.智慧.当前 (负数)
□ 施政进度 → add 角色.属性.官品.当前进度 (县令主题:官品进度)
□ 策略熟练 → add 角色.方略.方略进度.{策略ID}.熟练度
□ 理念感悟 → add 角色.理念.理念列表.{道名}.当前经验
□ 理念解锁 → set 角色.理念.理念列表.{道名} (完整DaoData,当前阶段从0开始)
□ 理念升阶 → set 角色.理念.理念列表.{道名}.当前阶段 (数值+1)
□ 策略解锁技能 → push 角色.方略.方略进度.{策略ID}.已解锁技能
...
□ NPC与NPC关系网 → push 社交.关系矩阵.edges (当同场出现>=2个NPC时,至少新增/更新1条NPC-NPC边)
   示例:{"action":"push","key":"社交.关系矩阵.edges","value":{"from":"李青云","to":"苏晚晴","relation":"同僚","score":25,"tags":["同势力","县衙"],"updatedAt":"【开元1050年3月15日 08:30】"}}
 □ 状态效果 → push 角色.效果 (buff/debuff)
 □ 世界事件 → push 社交.事件.事件记录

[物品指令示例](重要)
获得物品:{"action":"set","key":"角色.背包.物品.item_1705123456_abc","value":{"物品ID":"item_1705123456_abc","名称":"能量药剂","类型":"产品","品质":{"quality":"凡","grade":3},"数量":1,"描述":"..."}}
...
货币变化:{"action":"add","key":"角色.背包.货币.铜钱.数量","value":-10}

[理念指令示例](重要)
新悟理念:{"action":"set","key":"角色.理念.理念列表.治道","value":{"道名":"治道","当前阶段":0,"当前经验":0,"总经验":0,"阶段列表":[{"名称":"初任","突破经验":100},{"名称":"考功","突破经验":300}],"感悟记录":[],"关联":{"方略":[],"技能":[]}}}
增加经验:{"action":"add","key":"角色.理念.理念列表.治道.当前经验","value":50}
阶段突破:{"action":"set","key":"角色.理念.理念列表.治道.当前阶段","value":2}

[NPC指令示例](重要)
创建NPC:{"action":"set","key":"社交.关系.李青云","value":{"名字":"李青云","性别":"男","出生日期":{"年":1020,"月":3,"日":15},"种族":"人族","出生":"青云乡猎户之子","外貌描述":"身形修长,剑眉星目,面容清俊,一袭青衫随风而动,腰悬长剑,气质沉稳","性格特征":["沉稳","正直","重情义"],"官品":{"名称":"从九品","阶段":"后期"},"才能":{"名称":"文才","品级":"中品"},"能力":[{"名称":"明察秋毫","描述":"天生的洞察力"}],"先天六资":{"体魄":6,"才学":8,"明察":7,"气数":5,"声望":6,"操守":7},"属性":{"健康":{"当前":800,"上限":800},"威望":{"当前":600,"上限":600},"智慧":{"当前":200,"上限":200},"任期":{"当前":30,"上限":80}},"与玩家关系":"朋友","好感度":30,"人格底线":["背叛朋友","欺凌弱小"],"记忆":["初见时在山道相遇","曾一同处理案件"],"记忆总结":[],"当前位置":{"描述":"青云县·县衙","x":5100,"y":4900,"发展活力":45},"势力归属":"县衙","当前外貌状态":"神态自若,目光清明","当前内心想法":"正在思考如何处理棘手案件","背包":{"货币":{"铜钱":{"数量":100,"名称":"铜钱","单位":"枚"},"银两":{"数量":10,"名称":"银两","单位":"枚"}},"物品":{}},"实时关注":false}}
好感变化:{"action":"add","key":"社交.关系.李青云.好感度","value":10}
NPC记忆:{"action":"push","key":"社交.关系.李青云.记忆","value":"与玩家在处理悬案时合作"}
NPC内心想法:{"action":"set","key":"社交.关系.李青云.当前内心想法","value":"此人处事不凡，值得结交"}
NPC获得物品:{"action":"set","key":"社交.关系.李青云.背包.物品.item_1705123456_npc","value":{"物品ID":"item_1705123456_npc","名称":"精钢剑","类型":"装备","品质":{"quality":"玄","grade":5},"数量":1,"描述":"一柄寒光凛凛的精钢长剑"}}
NPC消耗物品:{"action":"delete","key":"社交.关系.李青云.背包.物品.item_1705123456_npc"}
NPC货币增加:{"action":"add","key":"社交.关系.李青云.背包.货币.铜钱.数量","value":50}
NPC货币减少:{"action":"add","key":"社交.关系.李青云.背包.货币.铜钱.数量","value":-30}
...
□ 策略名称:已存在于角色.策略.策略进度中的策略,必须使用存档中的策略ID
□ 货币名称:必须使用存档中角色.背包.货币里已有的币种ID
□ 大道名称:已存在于角色.大道.方略列表中的大道,必须使用存档中的道名
...
[数据结构]
只读:角色.身份/装备/技能.掌握技能;官品:小突破add进度,大突破set整体;NPC:必须一次性创建完整对象,字段缺失必须补齐合理默认值,禁止残缺对象
...
□ 顶级根:角色/社交/元数据/世界/系统
□ 角色子结构:角色.属性/角色.属性.官品/角色.属性.健康/角色.属性.民心/角色.属性.智慧/角色.属性.任期
□ 角色背包:角色.背包/角色.背包.物品/角色.背包.货币
□ 角色策略系统:角色.策略/角色.策略.策略进度/角色.大道/角色.大道.方略列表/角色.效果/角色.位置/角色.技能
...
数值字段(用add):好感度/健康.当前/民心.当前/智慧.当前/熟练度/当前经验/当前进度
...
[术语规范 - 县令模拟器主题]⚠️
必须使用县令模拟器主题术语,禁止使用修仙/武道术语:
- 使用"施政/批阅公文/处理政务"代替"修炼"
- 使用"治理方略/政策"代替"功法"
- 使用"官品/晋升/考核"代替"境界/突破"
- 使用"银两/库银/资金"代替"灵石"
- 使用"衙门/官府/县衙"代替"宗门"
- 使用"民心/威望"代替"灵气"
- 使用"政绩/功绩"代替"功德"
...
[县令模拟器核心资源]
人口、库银、民心、治安是县令治理的核心指标:
- 人口: 县治的居民数量,影响税收和征兵
- 库银: 县衙的财政储备,用于公共建设
- 民心: 百姓对县令的满意度,影响治理效果
- 治安: 县治的稳定程度,低治安可能导致盗贼横行
`.trim()
