...
[大道指令示例](重要)
新悟理念:{"action":"set","key":"角色.理念.理念列表.剑道","value":{"道名":"剑道","当前阶段":0,"当前经验":0,"总经验":0,"阶段列表":[{"名称":"入门","突破经验":100},{"名称":"初窥","突破经验":300}],"感悟记录":[],"关联":{"方略":[],"技能":[]}}}
增加经验:{"action":"add","key":"角色.理念.理念列表.剑道.当前经验","value":50}
阶段突破:{"action":"set","key":"角色.理念.理念列表.剑道.当前阶段","value":2}

[NPC指令示例](重要)
创建NPC:{"action":"set","key":"社交.关系.李青云","value":{"名字":"李青云","性别":"男","出生日期":{"年":1020,"月":3,"日":15},"种族":"人族","出生":"青云山脉猎户之子","外貌描述":"身形修长,剑眉星目,面容清俊,一袭青衫随风而动,腰悬长剑,气质出尘","性格特征":["沉稳","正直","重情义"],"城市等级":{"名称":"集镇","阶段":"后期"},"天赋":{"名称":"木天赋","品级":"中品"},"潜能":[{"名称":"剑心通明","描述":"对剑道有天生的感悟"}],"先天六司":{"根骨":6,"灵性":7,"悟性":8,"气运":5,"魅力":6,"心性":7},"属性":{"气血":{"当前":800,"上限":800},"灵气":{"当前":600,"上限":600},"神识":{"当前":200,"上限":200},"寿元上限":200},"与玩家关系":"朋友","好感度":30,"人格底线":["背叛朋友","欺凌弱小"],"记忆":["初见时在山道相遇","曾一同斩杀妖兽"],"记忆总结":[],"当前位置":{"描述":"青云山·练剑峰","x":5100,"y":4900,"发展活力":45},"势力归属":"青云会","当前外貌状态":"神态自若,目光清明","当前内心想法":"正在思考剑法精进之道","背包":{"货币":{"铜钱":{"数量":100,"名称":"铜钱","单位":"枚"},"银两":{"数量":10,"名称":"银两","单位":"枚"}},"物品":{}},"实时关注":false}}
...
□ 角色修炼:角色.策略/角色.策略.策略进度/角色.大道/角色.大道.大道列表/角色.效果/角色.位置/角色.技能
