...
[NPC指令示例](重要)
创建NPC:{"action":"set","key":"社交.关系.李青云","value":{"名字":"李青云","性别":"男","出生日期":{"年":1020,"月":3,"日":15},"种族":"人族","出生":"青云山脉猎户之子","外貌描述":"身形修长,剑眉星目,面容清俊,一袭青衫随风而动,腰悬长剑,气质出尘","性格特征":["沉稳","正直","重情义"],"官品":{"名称":"从九品","阶段":"后期"},"才能":{"名称":"文才","品级":"中品"},"能力":[{"名称":"明察秋毫","描述":"天生的洞察力"}],"先天六司":{"精力":6,"灵性":7,"悟性":8,"气运":5,"魅力":6,"心性":7},"属性":{"健康":{"当前":800,"上限":800},"威望":{"当前":600,"上限":600},"智慧":{"当前":200,"上限":200},"任期":{"当前":30,"上限":80}},"与玩家关系":"朋友","好感度":30,"人格底线":["背叛朋友","欺凌弱小"],"记忆":["初见时在山道相遇","曾一同处理案件"],"记忆总结":[],"当前位置":{"描述":"青云县·县衙","x":5100,"y":4900,"发展活力":45},"势力归属":"县衙","当前外貌状态":"神态自若,目光清明","当前内心想法":"正在思考如何处理棘手案件","背包":{"货币":{"铜钱":{"数量":100,"名称":"铜钱","单位":"枚"},"银两":{"数量":10,"名称":"银两","单位":"枚"}},"物品":{}},"实时关注":false}}
