...
- 官品体系：根据世界背景选择合适的官品体系（如古代官场用九品制，现代官场用行政级别）
- 势力类型：根据世界背景选择合适的势力类型（如官场用衙门/部门，商业用商号/钱庄）
...
### 势力分布参考
衙门(40-50%) | 商号(20-30%) | 学府(10-20%) | 民间组织(10-15%) | 钱庄(5-15%) | 特殊势力(5-10%)
...
\`\`\`json
{
  ...
  "按官品": {
    // 🚨 官品不能超过领导层.最高官品
    // 官品等级：九品 < 八品 < 七品 < 六品 < 五品 < 四品 < 三品 < 二品 < 一品
    "九品": 数量,
    "八品": 数量
  },
  "按职位": {
...
2. 城镇坊市 - 城镇聚居地（集市、城池）
3. 治所衙门 - 官府驻地（县衙、府衙）
4. 商贾之地 - 商业区域（商号、钱庄、集市）
5. 凶险之地 - 危险区域（山贼巢穴、禁地）
6. 其他特殊 - 特殊地点（遗迹、古战场入口）
