...
- **画面感配方**：至少1段简短【环境】（1-2句，体现衙门氛围：肃穆/萧条/暗流涌动）+ 2-3个具体动作细节（接印/整冠/展开文书）+ 1-2轮对话
- 严禁游戏术语和数据罗列
...
### 开局必须初始化的数据
□ 时间：add \`元数据.时间.分钟\` (⚠️时间由系统管理,只需添加流逝分钟数,严禁set整个时间对象)
□ 位置：set \`角色.位置\` {描述,x,y}
□ 声望：set \`角色.属性.威望\`
□ 资源：set \`角色.背包.货币.银两.数量\`
□ 官品：set \`角色.属性.官品\` {名称:"九品",阶段:"初期",当前进度:0,下一级所需:100,晋升描述:"需完成更多政务以晋升"}
